...
describe('Test suite for CSR',function() {

	CSRPageObj = new product_page();
	...
	it('Cracked Screen Repair',function() {
				browser.sleep(3000);
				console.log("Cracked Screen Repair started");
			...
			//	browser.actions().sendKeys(protractor.Key.TAB).perform();
				...
				element(by.xpath("//ngx-braintree/div/div/div[1]/div/div[4]/div/div[2]/div/div[2]/h4")).getText().then(function(text){
					console.log("Payable Amount is "+text);
					browser.sleep(3000);
				});
